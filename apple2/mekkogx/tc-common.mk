...
CFLAGS += $(CFLAGS_EXTRA) $(CFLAGS_EXTRA_$(TOOLCHAIN_UC)) $(CFLAGS_EXTRA_$(PLATFORM_UC))
ASFLAGS += $(ASFLAGS_EXTRA) $(ASFLAGS_EXTRA_$(TOOLCHAIN_UC)) $(ASFLAGS_EXTRA_$(PLATFORM_UC))
LDFLAGS += $(LDFLAGS_EXTRA) $(LDFLAGS_EXTRA_$(TOOLCHAIN_UC)) $(LDFLAGS_EXTRA_$(PLATFORM_UC))
