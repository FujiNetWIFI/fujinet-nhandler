...
.local RelocTable
	...
	.word w91+1,w92+1,w93+1,w93a+1,w93b+1,w94+1,w95+1,w96+1,w97+1,w98+1,w99+1,w100+1,w100a+1,w100b+1
...
.def	:w100a
	...
	LDA	DVSTAT+2
.def	:w100b
	STA	CONNSAV		; Return conn status.
       RTS
...
CONNSAV .DS	1	; Status Connection save
RESSAV  .DS     1	; Status Result save
